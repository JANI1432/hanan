...
{uu}  ██   ██ ██   ██  ███ ███ 
\033[1;93m=================================
\033[1;97m Owner  : JANI x Wasi :/
\033[1;97m GitHub : JANI-404 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/JANI-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=JANI-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=JANI-2233]'))
